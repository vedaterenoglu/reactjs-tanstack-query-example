...
export const useCities = () => {
  ...
  const citiesCount = useSelector(selectCitiesCount)
  const filteredCitiesCount = useSelector(selectFilteredCitiesCount)
...
export const useCitySearch = () => {
  ...
  const isLoading = useSelector(selectIsLoading)
  const error = useSelector(selectError)
  const filteredCount = useSelector(selectFilteredCitiesCount)
